...
export default function Hero() {
  return (
    <section id ="inicio" className="relative min-h-screen flex items-center justify-center text-white px-6">
      ...
      <div className="relative z-10 max-w-4xl text-center">
        ...
        />
        <p className=" sm:text-base tracking-[0.35em] text-white/100 uppercase mb-8">
  ...
  <button
    ...
    className=" w-12 h-12 rounded-full border border-white/30 flex items-center justify-center animate-bounce hover:border-white/60transition"
  >
    ↓
</button>
</div>
